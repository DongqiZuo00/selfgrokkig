...
def main():
    ...
    parser.add_argument('--output', type=Path, default=ROOT / 'evidence/result_analysis_training.json')
    args = parser.parse_args()
    destination = args.output.resolve()
    assert destination.is_relative_to(ROOT / 'evidence'), 'Write the new analysis only inside this release evidence folder.'
