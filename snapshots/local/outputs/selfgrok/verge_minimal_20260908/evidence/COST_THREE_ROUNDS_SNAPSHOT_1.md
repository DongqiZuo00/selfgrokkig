...
状态：**snapshot_or_needs_reconciliation**；UTC 统计时间：2026-09-08T19:34:51.840244+00:00。

累计保存的实际 native generation：**822,497 tokens**。Slurm 分配：**2.120556 B200 小时**。原两轮 `COST_AND_BUDGET.md/json` 保留。

| 类别 | 实际 native tokens |
|---|---:|
| solver_training | 614,074 |
| solver_evaluation | 110,234 |
| challenger | 8,092 |
| stage_probe | 90,097 |
...
| round3_g1 | 40,634 | 16,229 | 0 | 0 |
| round3_g2 | 49,152 | 0 | 0 | 0 |
| round3_g3 | 0 | 0 | 0 | 0 |
| round3_direct | 0 | 0 | 0 | 0 |
...
| 41420288_0 | RUNNING | 413 | 0.114722 |
| 41420288_1 | RUNNING | 384 | 0.106667 |
| 41420288_2 | PENDING | 0 | 0.000000 |
| 41420288_3 | PENDING | 0 | 0.000000 |
...
核验 730 个独立 generation 来源；missing scheduler tasks=[]；全部指定任务终止=False。
