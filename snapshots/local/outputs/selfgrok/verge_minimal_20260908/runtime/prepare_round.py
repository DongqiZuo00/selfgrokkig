...
def main(output):
    ...
    write_json(output / "READY.json", {"status": "real_base_and_challenger_complete", "plan": str(output / "plan.json"),
        ...
        "baseline_contract_sha256": baseline["baseline_contract_sha256"],
        "target_rows": str(VIEW / "target_rows.json"), "target_rows_sha256": sha256(VIEW / "target_rows.json"),
        "catalogue": str(CATALOGUE), "catalogue_sha256": sha256(CATALOGUE),
