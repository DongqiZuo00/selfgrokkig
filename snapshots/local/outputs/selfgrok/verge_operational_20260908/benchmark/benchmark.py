...
def evaluate_program(program, cases, create_factory):
    ...
    try:
        # Exact existing-project completion adapter: choose by textual order,
        # never parser validity or reward. The supplied raw string stays intact.
        factory = create_factory(extract_program(program))
